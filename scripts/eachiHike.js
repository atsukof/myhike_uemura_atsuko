...
function saveHikeDocumentIDAndRedirect(){
    ...
    localStorage.setItem("hikeID", ID) //key, value
    window.location.href = "review.html" // pass values to another page
}
...
function populateReviews() {
    ...
    db.collection("reviews")
        .where("hikeDocID", "==", hikeID) // go and see if the hike ID matches 
        .get()
        .then((allReviews) => {
